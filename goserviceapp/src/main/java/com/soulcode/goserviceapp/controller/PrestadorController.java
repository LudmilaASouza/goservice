...
public class PrestadorController {
    ...
    public String adicionarEspecilidade(@RequestParam(name = "servicoId") Long id, Authentication authentication, RedirectAttributes attributes){
        try{
            ...
            attributes.addFlashAttribute("errorMessage", "Erro ao adicionar nova especilidade.");
        }
        return "redirect:/prestador/dados";
    }
